from django.forms import Form, CharField, PasswordInput, EmailField, ModelChoiceField, ValidationError
...
class SignupForm(Form):
    ...
    # TODO: [SIT-01] Default option should be extracted from user's IP based location
    ...
    def clean_username(self):
        ...
        # TODO: [FOR-01] Only alphanumeric and a few special chars should be allowed in username
        # Currently, it's also possible to have usernames with @ and dash, should be discussed if ok
